...
if __name__ == '__main__':
    ...
    with open("data/conf/log/expert_actions.csv", "r") as expert_action_file:
    ...
    with open("data/ddqn/log/agent_actions_2/agent_actions1.csv", "r") as ddqn_action_file:
    ...
    with open("data/ddqn/log/agent_actions_2/agent_actions3.csv", "r") as ddqn_action_file:
        reader = csv.reader(ddqn_action_file)
        data = list(reader)
        for i in range(len(data)):
            sum = 0
    ...
    with open("data/conf_dagger/data_1/duration.csv", "x", newline='') as target_file:
